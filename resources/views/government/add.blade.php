...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Form Tambah OPD <small>Lengkapi Form berikut ini</small></h2>
                ...
                <div class="x_content">
                    <br />
                    <form action="/government/insert" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="addrress" name="address" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
