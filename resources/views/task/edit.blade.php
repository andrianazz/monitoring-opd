...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Form Edit Kegiatan <small>Lengkapi Form berikut ini</small></h2>
                ...
                <div class="x_content">
                    <br />
                    <form method="POST" action="/task/{{$data->id}}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        @method('PUT')
                        @csrf
                        ...
                        <input type="hidden" name="government_id" value="{{ $opd }}">
